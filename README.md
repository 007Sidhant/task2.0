...
## 📌 Description
Eventify is a Notion-like productivity tool that helps users organize tasks, notes, and projects efficiently.
...
<head>
    ...
    <title>Eventify - Your Productivity Hub</title>
    <style>
        body {
...
📌 *Output Preview:* This code creates a basic webpage for Eventify with a button.
